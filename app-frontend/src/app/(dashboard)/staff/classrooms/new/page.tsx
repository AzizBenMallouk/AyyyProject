                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-white/5">
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        required
                                    >
                                        <option value="" disabled className="bg-[#0a0a0f]">Select Program</option>
                                        {programs.map(p => (
                                            <option key={p.id} value={p.id} className="bg-[#0a0a0f]">{p.title} (v{p.version})</option>
                                        ))}
                                    </select>
                                    {errors.programId && <p className="text-red-400 text-[10px] mt-1">{errors.programId}</p>}
                                </div>
