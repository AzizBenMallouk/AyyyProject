...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant, size, asChild = false, ...props }, ref) => {
        ...
        // If it's a Slot, we can't easily wrap it in motion.button without breaking generic composition
        // So distinct implementation for now. Enhancing standard buttons with motion.
        if (asChild) {
            return (
                <Comp
        ...
        // Using motion.button for satisfying click effect
        return (
            <motion.button
                className={cn(buttonVariants({ variant, size, className }))}
                ref={ref}
